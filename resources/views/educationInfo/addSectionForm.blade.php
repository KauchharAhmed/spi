...
<!-- end sesssion message-->
    ...
    <strong> Must Be Filled Input Box Which Symbol Is <span style="color:red ; padding-left:5px;" >*</span>
                ...
                {!! Form::open(['url' =>'addSectionInfo','method' => 'post']) !!}
                        <div class="form-group m-form__group">
                        <label for="full_name">Department </label><span style="color:red ; padding-left:30px;" >*</span>
                        <select class="form-control m-input m-input--square" name="department" required="">
                    ...
                    <div class="form-group m-form__group">
                        <label for="full_name">Section </label><span style="color:red ; padding-left:30px;" >*</span>
                        <input type="text" class="form-control m-input m-input--square" name="section" placeholder="Section" required="">  
                    </div>
                    <div class="form-group m-form__group">
