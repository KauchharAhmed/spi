...
<!-- end sesssion message-->
    ...
    <strong> Must Be Filled Input Box Which Symbol Is <span style="color:red ; padding-left:5px;" >*</span>
                ...
                {!! Form::open(['url' =>'addSessionInfo','method' => 'post']) !!}
                    <div class="form-group m-form__group">
                        <label for="full_name">Session </label><span style="color:red ; padding-left:30px;" >*</span>
                        <input type="text" class="form-control m-input m-input--square" name="session" placeholder="Session" required="">  
                    </div>
                    ...
                    <div class="form-group m-form__group">
                       <button type="submit" class="btn btn-primary">ADD NEW SESSION</button>
                    </div>
                </div>
                {!! Form::close() !!}
