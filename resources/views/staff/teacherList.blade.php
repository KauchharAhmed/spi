        ...
        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                      <a href="{{URL::to('addTeacherForm')}}" class="btn btn-outline-brand active">
                        <span>
        ...
        <table class="m-datatable" id="html_table" width="100%">
            ...
            <tbody>
              ...
              foreach ($result as $value) { ?>
                <tr>
                <td><?php echo $i++ ; ?></td>
                <td><?php echo $value->rfidCardNo;?></td>
              ...
              <?php endif;?>
                    ...
                    <?php endif;?></td>
                       <td><a class="btn btn-warning" onclick="return confirm('Are You Sure You Want To Transfet To The Teacher ?')" href="">TRANSFER</a></td>
                    <td>
                    <a class="btn btn-primary" href="{{URL::to('editTeacherInfo/'.$value->id)}}">EDIT</a>
                    </td> 
            </tr>
            <?php } ?>
            </tbody>
