        ...
        <table class="m-datatable" id="html_table" width="100%">
            ...
            <tbody>
              ...
              foreach ($result as $value) { ?>
                ...
                <td> <a class="btn btn-info" href="{{URL::to('viewApplication/'.$value->id)}}">VIEW APPLICATION</a></td>
                <td> <?php if($value->status==0){ ?>
                    <a class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Delete It ?')" href="{{URL::to('deleteApplication/'.$value->id)}}">DELETE</a>
                <?php }?>
                </td>  
            </tr>
            <?php } ?>
