...
<!-- end sesssion message-->
    ...
    <strong> Must Be Filled Input Box Which Symbol Is <span style="color:red ; padding-left:5px;" >*</span>
                ...
                {!! Form::open(['url' =>'addCraftInsInfo','method' => 'post','files' => true]) !!}
                <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control m-input m-input--square" name="short_name" placeholder="Short Name">  
                    </div>
                        <div class="form-group m-form__group">
                ...
                <div class="col-md-6">
                    ...
                    <label for="full_name">Joining Date &nbsp; (yyyy-mm-dd)</label>
                        ...
                        <input type="text" class="form-control m-input m-input--square" name="index_no" placeholder="Index No">  
                    </div>
                    ...
                    <div class="form-group m-form__group">
                       <button type="submit" class="btn btn-primary">ADD NEW CRAFT INSTRUCTOR</button>
                    </div>
                </div>
