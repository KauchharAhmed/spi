...
<!-- end sesssion message-->
    ...
    <strong> Must Be Filled Input Box Which Symbol Is <span style="color:red ; padding-left:5px;" >*</span>
                ...
                {!! Form::open(['url' =>'addStaffTraningInfo','method' => 'post','files' => true]) !!}
                   <div class="form-group m-form__group">
                    ...
                    <div class="form-group m-form__group">
                    <label for="full_name">Traning Date</label><span style="color:red ; padding-left:30px;" >*</span>
                        <input type="text" class="form-control" id="m_datepicker_1" placeholder="Select Traning Date" name="from" data-date-format="dd-mm-yyyy" required="">
                    </div>
              ...
              <br/><br/><br/>
               ...
               <br/><br/>
                    <div class="form-group m-form__group">
                       <button type="submit" class="btn btn-primary">ADD STAFF TRANING</button>
                    </div>
                </div>
                {!! Form::close() !!}
