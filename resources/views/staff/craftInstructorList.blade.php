        ...
        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                      <a href="{{URL::to('addCraftInstructorForm')}}" class="btn btn-outline-brand active">
                        <span>
                           <i class="fa fa-plus-square" aria-hidden="true"></i>
                            <span>ADD NEW CRAFT INSTRUCTOR</span>
                        </span>
                    </a>
        ...
        <table class="m-datatable" id="html_table" width="100%">
            ...
            <tbody>
              ...
              <?php endif;?>
                    ...
                    <a class="btn btn-warning" href="{{URL::to('addStaffRfidNumber/'.$value->id)}}">ADD RFID CARD NO</a>
                    <?php else:?>
                    <strong>COMPLETED</strong>
                    <?php endif;?></td>
                <td> <a class="btn btn-primary" href="{{URL::to('editCraftInfo/'.$value->id)}}">EDIT</a></td> 
            </tr>
            <?php } ?>
            </tbody>
        </table>
