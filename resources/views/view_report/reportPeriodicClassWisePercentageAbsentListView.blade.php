            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    <div class="m-section__content">
                      <div class="row">
                              {!! Form::open(['url' =>'printPeriodicClassWisePercentageAbsentList','method' => 'post']) !!}
                        ...
                        <button class="btn btn-primary m-r-5 m-b-5" > <i class="fa fa-print" style="padding-right:10px"></i>PRINT</button>
                         {!! Form::close() !!}
                           &nbsp;&nbsp;&nbsp;
                            {!! Form::open(['url' =>'csvPeriodicClassWisePercentageAbsentList','method' => 'post']) !!}
                            <input type="hidden" name="year" value="<?php echo $year;?>">
                            <input type="hidden" name="dept" value="<?php echo $dept;?>">
                            <input type="hidden" name="shift" value="<?php echo $shift;?>">
                            <input type="hidden" name="semister" value="<?php echo $semister;?>">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-3"></div>
                          <div class="col-md-8"><strong style="font-size:20px;color: black;font-weight: bold"> PERIODIC CLASS WISE PERCENTAGE ABSENT LIST</strong></div>
                  ...
                  <thead>
                    ...
                    <th style="background-color: #ad8fd0;text-align: center;color: white;font-weight: bold;font-family: monospace;"><strong>ABSENT SUBJECT CLASS %</strong></th>
                               ...
                               <tbody>
                                <?php if($sorting_type == '1' AND $percentage_class_number == 100 - $value->count):?>
                                 <tr>
                              ...
                              <?php elseif($sorting_type == '2' AND $percentage_class_number < 100 - $value->count):?>
                                 <tr>
                                    <td style="font-size: 20px;color: black;text-align: center;"><?php echo $i++ ; ?></td>
                                      <td style="font-size: 20px;color: green; font-weight:bold;text-align: center;"><?php echo $j++ ; ?></td>
                                    <td style="font-size: 20px;color: black;text-align: center;"><?php echo $value->roll ; ?></td>   
                                  ...
                                  <?php elseif($sorting_type == '3' AND $percentage_class_number > 100 - $value->count):?>
                                 <tr>
                                    <td style="font-size: 20px;color: black;text-align: center;"><?php echo $i++ ; ?></td>
                                      <td style="font-size: 20px;color: green; font-weight:bold;text-align: center;"><?php echo $j++ ; ?></td>
                                    <td style="font-size: 20px;color: black;text-align: center;"><?php echo $value->roll ; ?></td>   
                              ...
                              <?php if($sorting_type == '1' AND $percentage_class_number == '100') :?>
