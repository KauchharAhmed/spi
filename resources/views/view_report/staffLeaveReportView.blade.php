            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    <div class="m-section__content">
                      ...
                      <div class="col-md-2">
                        {!! Form::open(['url' =>'printStaffLeaveReport','method' => 'post']) !!}
                      ...
                      <div class="col-md-4"></div>
                            <div class="col-md-6"><strong style="font-size:20px;color: black;font-weight: bold">STAFF LEAVE REPORT </strong></div>
                  ...
                  <thead>
                    ...
                    <th style="background-color: #ad8fd0;text-align: center;color: white;font-weight: bold;font-family: monospace;"><strong>LEAVE DATE</strong></th>
