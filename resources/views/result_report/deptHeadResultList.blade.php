             ...
             <div class="row">
                 <div class="col-md-2">
                    ...
                    <select class="form-control m-input" name="year" id="year">
                        ...
                        <?php foreach ($year as $year_value) { ?>
                            <option value="<?php echo $year_value->year ; ?>" ><?php echo $year_value->year ;?></option>
                        <?php } ?> 
                    </select> 
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                       ...
                       <button type="submit" id="send_button" class="form-control  btn btn-primary" style="margin-top:6px">Get Result List</button>             
                </div>
                </div>
            </div>
...
<script>
    ...
    $.ajax({
        'url':"{{ url('/deptHeadResultListView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        shift:shift,
