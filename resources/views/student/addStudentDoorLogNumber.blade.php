        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                     ADD STUDENT DOOR LOG CARD NUMBER
                </h3>
            </div>
        </div>
    </div>
...
<div class="col-md-3"></div>
<div class="col-md-2" style="font-weight: bold;color:red;">Machine No :</div>
<div class="col-md-1"> : </div>
<div class="col-md-2"><span style="color:red; font-size: 20px;"><?php echo $machine_no ;?></span></div>
<div class="col-md-4"></div>
</div>

       <?php
       $rfid_salt = $machine_no.'00000'; 
       ?>
             {!! Form::open(['url' =>'addStudentDoorLogNo','method' => 'post']) !!}
             <div class="row" style="margin-left: 250px;">
              <input type="hidden" name="rfid_salt" value="<?php echo $rfid_salt ;?>">
            <div class="form-group m-form__group">
                        <label for="full_name">Enter RfId Number</label> 
                        <input type="text" class="form-control m-input m-input--square" name="rfid" required="">
                    </div>
                <div class="form-group m-form__group">
                       <label for="phone_number"></label>
                       <button type="submit" id="send_button" class="form-control  btn btn-primary" style="margin-top:6px;margin-left: 30px;">Add Door Log Card Number</button>             
                </div>
