              ...
              <div class="col-md-12">
                ...
                <div class="col-md-2">
                  ...
                  <label for="phone_number">Roll</label>
                      <input type="text" name="roll" class="form-control m-input" id="roll">
                      </div>

                <br/><br/><br/>
                <div class="col-md-2">
                       <label for="phone_number"></label>
                       <button type="submit" id="send_button" class="form-control btn btn-primary btn-sm" style="margin-top:6px">Search To Promote</button>             
                </div>
                </div>
            </div>
        <!--end: Search Form -->
