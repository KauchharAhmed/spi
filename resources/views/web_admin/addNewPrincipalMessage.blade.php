...
<!-- end sesssion message-->
    ...
    <strong> Must Be Filled Input Box Which Symbol Is <span style="color:red ; padding-left:5px;" >*</span>
                ...
                {!! Form::open(['url' =>'insertPrincipalMessage','method' => 'post','files' => true]) !!}
                    <div class="form-group m-form__group">
                        <label for="principal_name">Principal Name</label><span style="color:red ; padding-left:30px;" >*</span>
                        <input type="text" class="form-control m-input m-input--square" name="principal_name" placeholder="Principal Name" required="">  
                    </div>
                    <div class="form-group m-form__group">
                        <label for="phone_number">Message</label> <span style="color:red ; padding-left:30px;" >*</span>
                        <textarea type="text" class="form-control m-input m-input--square" name="principal_message" placeholder="Message"></textarea>
                    </div>
                    <div class="form-group m-form__group">
