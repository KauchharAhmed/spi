                    ...
                    <div class="m-portlet__head-title">
                        ...
                        <i class="la la-gear"></i>
                            ...
                            <div class="row">
                                ...
                                <br/>
                             <span style="font-family: sans-serif">Please Enter Pin And Password</span>
                         </center>
...
<?php } ?>
           <!--begin::Form-->
            {!! Form::open(['url' => 'finalRecoveryAccount','method' => 'post']) !!}
                <div class="m-portlet__body" style="background: aliceblue;">

                    <div class="form-group m-form__group">
                        <label for="exampleInputEmail1" style="font-family: tahoma;font-weight: bold;">Enter PIN</label>
                        <input type="text" class="form-control m-input m-input--square" name="code" aria-describedby="emailHelp" placeholder="Enter Verify PIN" required="">  
                    </div>

                        <div class="form-group m-form__group">
                        <label for="exampleInputEmail1" style="font-family: tahoma;font-weight: bold;">New Password</label>
                        <input type="password" class="form-control m-input m-input--square" name="password" aria-describedby="emailHelp" placeholder="New Password" required="">  
                    </div>
                        <div class="form-group m-form__group">
                        <label for="exampleInputEmail1" style="font-family: tahoma;font-weight: bold;">Retype New Password</label>
                        <input type="password" class="form-control m-input m-input--square" name="confirm_password" aria-describedby="emailHelp" placeholder="Retype New Password" required="">  
                    </div>

                    <input type="hidden" name="id" value="<?php echo $id;?>" required="">
                    <input type="hidden" name="random_session_value" value="<?php echo $random_session_value;?>" required="">
                ...
                <div class="m-portlet__foot m-portlet__foot--fit" style="background: aliceblue;">
                    <div class="m-form__actions">
                        <button type="submit" class="btn btn-primary" style="margin-left: 28PX;margin-bottom: 16PX;margin-top: 16px;">RECOVERY YOUR ACCOUNT</button>
