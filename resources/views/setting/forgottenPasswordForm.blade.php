                    ...
                    <div class="m-portlet__head-title">
                        ...
                        <i class="la la-gear"></i>
                            ...
                            <div class="row">
                                ...
                                <br/>
                             <span style="font-family: sans-serif">Recovery Your Account</span>
                         </center>
...
<?php } ?>
           <!--begin::Form-->
            {!! Form::open(['url' => 'forgottenPasswordMobileVerify','method' => 'post']) !!}
                <div class="m-portlet__body" style="background: aliceblue;">

                    <div class="form-group m-form__group">
                        <label for="exampleInputEmail1" style="font-family: tahoma;font-weight: bold;">Mobile Number (Your Login ID)</label>
                    ...
                    <div class="form-group m-form__group">
                        <label style="font-family: tahoma;font-weight: bold;">User As </label>
                ...
                <div class="m-portlet__foot m-portlet__foot--fit" style="background: aliceblue;">
                    <div class="m-form__actions">
                        <button type="submit" class="btn btn-primary" style="margin-left: 28PX;margin-bottom: 16PX;margin-top: 16px;">NEXT</button>
