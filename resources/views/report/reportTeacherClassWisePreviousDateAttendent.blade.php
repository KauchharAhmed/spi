        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                  PREVIOUS DATE CLASS WISE TEACHER ATTENDENT REPORT
                </h3>
            </div>
        </div>
    </div>
...
@endif
             <div class="row">
              <div class="col-md-12">
                <span style="color:green">PREVIOUS DATE CLASS WISE TEACHER ATTENDENT REPORT</span>
              </div>
                    <div class="col-md-2">
...
<script>
 $('#send_button').click(function(e){
    ...
    if(from == ''){
      ...
      $.ajax({
        'url':"{{url('/reportTeacherClassWisePreviousDateAttendentView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from:from,
