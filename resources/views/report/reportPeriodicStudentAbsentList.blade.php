        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                   PERIODIC STUDENT ABSENT ATTENDENT REPORT
                </h3>
            </div>
        </div>
    </div>
...
@endif
             ...
             <div class="row">
              <div class="col-md-12">
                <span style="color:green">Search To Periodic Student Absent Attendent Report</span>
              </div>
                <div class="col-md-2">
                   <label>Year</label>
...
<script>
    ...
    $.ajax({
        'url':"{{url('/reportPeriodicStudentAbsentListView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        year:year,
