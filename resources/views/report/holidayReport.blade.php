...
@endif
             <div class="row">
              <div class="col-md-12">
                <span style="color:green">Holiday Report</span>
              </div>
                    <div class="col-md-2">
                  ...
                  <div class="col-md-6">
                    <div class="form-group m-form__group">
                    <label for="full_name">Holiday </label>
                         <select class="form-control m-input m-input--square" id="holiday_type" name="holiday_type" required="">
                          <option value="">All</option>
                          <option value="1/0">Weekly</option>
...
<script>
    ...
    var to                 = $('[name="to"]').val();
    var holiday_type       = $('[name="holiday_type"]').val();
    if(from == ''){
