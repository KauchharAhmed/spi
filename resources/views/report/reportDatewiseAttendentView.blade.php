            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    <div class="m-section__content">
                      <div class="row">
                            {!! Form::open(['url' =>'printDateWiseAttendentReport','method' => 'post']) !!}
                         ...
                         &nbsp;&nbsp;&nbsp;
                          ...
                          {!! Form::open(['url' =>'csvDateWiseAttendentReport','method' => 'post']) !!}
                            <input type="hidden" name="year" value="<?php echo $year; ?>">
                            <input type="hidden" name="shift" value="<?php echo $shift; ?>">
                            <input type="hidden" name="semister" value="<?php echo $semister; ?>">
                            <input type="hidden" name="section" value="<?php echo $section; ?>">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-3"></div>
                          <div class="col-md-8"><strong style="font-size:20px;color: black;font-weight: bold">PERIODIC STUDENT CLASS ATTENDENT REPORT</strong></div>
