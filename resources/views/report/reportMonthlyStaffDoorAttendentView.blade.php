            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    <div class="m-section__content">
                      <div class="row">
                          {!! Form::open(['url' =>'printReportMontlyStaffDoorAttendentView','method' => 'post']) !!}
                        ...
                        <button class="btn btn-primary m-r-5 m-b-5" > <i class="fa fa-print" style="padding-right:10px"></i>PRINT</button>
                         {!! Form::close() !!}
                          &nbsp;&nbsp;&nbsp;
                          {!! Form::open(['url' =>'csvReportMontlyStaffDoorAttendentView','method' => 'post']) !!}
                        <input type="hidden" name="year" value="<?php echo $year;?>">
                        <input type="hidden" name="month" value="<?php echo $month;?>">
                        <input type="hidden" name="staff_type" value="<?php echo $staff_type;?>">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-3"></div>
                            <div class="col-md-7"><strong style="font-size:20px;color: black;font-weight: bold">MONTHLY STAFF DOOR ATTENDENT REPORT </strong></div>
                    ...
                    <table>
                      <tr>
                        ...
                        <td style="font-family: tahoma;font-size: 16px;color: black;padding: 5px 0px;">:</td>
                        <td style="font-family: tahoma;font-weight:bold;font-size: 16px;color: black;padding: 5px 5px 0px; "><?php echo $month_total_day ;?></td>
                      </tr>
                             <tr>
                        <td style="font-family: tahoma;font-size: 16px;color: black;padding: 5px 0px;">  HOLIDAYS</td>
                        <td style="font-family: tahoma;font-size: 16px;color: black;padding: 5px 0px;">:</td>
                        <td style="font-family: tahoma;font-weight:bold;font-size: 16px;color: black;padding: 5px 5px 0px; "><?php echo $count_holiday ; ?></td>
                      </tr>
                    </table>  
                      <!--begin: Search Form -->
                    <div class="container">
                  ...
                  <thead>
                    ...
                    <th style="background-color: #ad8fd0;text-align: center;color: white;font-weight: bold;font-family: monospace;"><strong>TOTAL WORKING (DAYS)</strong></th>
                    <th style="background-color: #ad8fd0;text-align: center;color: white;font-weight: bold;font-family: monospace;"><strong>TOTAL LEAVE & TRAINING (DAYS)</strong></th>
                    <th style="background-color: #ad8fd0;text-align: center;color: white;font-weight: bold;font-family: monospace;"><strong>TOTAL WORKING (DAYS)<sub>with out leave & training</sub></strong></th>
