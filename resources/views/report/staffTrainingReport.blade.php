...
@endif
             <div class="row">
              <div class="col-md-12">
                <span style="color:green">Staff Training Report</span>
              </div>
                    <div class="col-md-2">
                  ...
                  <div class="col-md-6">
                    <div class="form-group m-form__group">
                    <label for="full_name">Staff </label>
                        <select class="form-control" name="staff" id="staff">
                        <option value="0">ALL</option>
                        <?php foreach ($result as $value) { ?>
                         <option value="<?php echo $value->id;?>"><?php echo $value->name.' -> '.$value->departmentName.' -> '.$value->degi;?>
                         </option>
                         <?php } ?>                          
                        </select>
                    </div>
...
<script>
    ...
    $.ajax({
        'url':"{{url('/staffTrainingReportView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        from:from,
