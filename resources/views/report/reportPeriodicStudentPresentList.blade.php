        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                   PERIODIC STUDENT PRESENT ATTENDENT REPORT
                </h3>
            </div>
        </div>
    </div>
...
@endif
             ...
             <div class="row">
              ...
              <div class="col-md-12">
                <span style="color:green">Search To Periodic Student Present Attendent Report</span>
              </div>
                <div class="col-md-2">
                   <label>Year</label>
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                    ...
                    <label for="full_name">Days </label>
                        <input type="number" class="form-control" name="attendent_days" id="attendent_days">
                    </div>
                </div>
                    <div class="col-md-2">
                    <div class="form-group m-form__group">
...
<script>
    ...
    var attendent_days    = $('#attendent_days').val();
    ...
    if(sorting_type == ''){
      alert('Please Select Sorting Type');
      return false;
    }
    if(attendent_days == ''){
      alert('Please Enter Days Type');
      return false;
    }
     if(from == ''){
    ...
    $.ajax({
        'url':"{{url('/reportPeriodicStudentPresentListView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        year:year,
