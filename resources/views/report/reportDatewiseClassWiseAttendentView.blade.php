            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    <div class="m-section__content">
                      <div class="row">
                             {!! Form::open(['url' =>'printDatewiseClasswiseAttendentReport','method' => 'post']) !!}
                        ...
                        <button class="btn btn-primary m-r-5 m-b-5" > <i class="fa fa-print" style="padding-right:10px"></i>PRINT</button>
                         {!! Form::close() !!}
                           &nbsp;&nbsp;&nbsp;
                            {!! Form::open(['url' =>'csvDatewiseClasswiseAttendentReport','method' => 'post']) !!}
                            <input type="hidden" name="year" value="<?php echo $year;?>">
                            <input type="hidden" name="shift" value="<?php echo $shift;?>">
                            <input type="hidden" name="dept" value="<?php echo $dept;?>">
                            <input type="hidden" name="semister" value="<?php echo $semister;?>">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-3"></div>
                          <div class="col-md-8"><strong style="font-size:20px;color: black;font-weight: bold">DATEWISE CLASS WISE STUDENT ATTENDENT REPORT</strong></div>
