        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                  PERIODIC CLASS WISE TOP PRESENT LIST
                </h3>
            </div>
        </div>
    </div>
...
@endif
             ...
             <div class="row">
              <div class="col-md-12">
                <span style="color:green">Search To Periodic Class Wise Top Present List</span>
              </div>
                <div class="col-md-2">
                   <label>Year</label>
...
<script>
    ...
    $.ajax({
        'url':"{{url('/reportPeriodicClassWiseTopPresentListView') }}",
        'type':'post',
        'dataType':'text',
        data:{  
        year:year,
