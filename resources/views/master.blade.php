...
<head>
    ...
    <link rel="icon" type="image/png" href="{{URL::to('assets/img/favicon-16x16.png')}}" sizes="16x16">
    <link rel="icon" type="image/png" href="{{URL::to('assets/img/favicon-32x32.png')}}" sizes="32x32">

    <title>ASIAN IT INC</title>
    ...
    <!-- additional styles for plugins -->
        ...
        <!-- chartist -->
        <link rel="stylesheet" href="{{URL::to('bower_components/chartist/dist/chartist.min.css')}}">
    ...
    <!-- style switcher -->
    <link rel="stylesheet" href="{{URL::to('assets/css/style_switcher.min.css')}}" media="all">
    
    <!-- altair admin -->
    <link rel="stylesheet" href="{{URL::to('assets/css/main.min.css')}}" media="all">

    <!-- themes -->
    <link rel="stylesheet" href="{{URL::to('assets/css/themes/themes_combined.min.css')}}" media="all">
...
<body class=" sidebar_main_open sidebar_main_swipe">
                        ...
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            ...
                            <div class="uk-dropdown uk-dropdown-small">
                                <ul class="uk-nav js-uk-prevent">
                                    ...
                                    <li><a id="logout" href="{{URL::to('logout')}}">Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="menu_section">
            ...
            <ul>
                ...
                <li title="Menu">
                    ...
                    <ul>
                        <li><a href="{{URL::to('add_contact')}}">Add Contact</a></li>
                        <li><a href="{{URL::to('manage_contact')}}">Manage Contact</a></li>
                    </ul>
                </li>
    ...
    <!-- datatables buttons-->
    <script src="{{URL::to('bower_components/datatables-buttons/js/dataTables.buttons.js')}}"></script>
    <script src="{{URL::to('assets/js/custom/datatables/buttons.uikit.js')}}"></script>
    <script src="{{URL::to('bower_components/jszip/dist/jszip.min.js')}}"></script>
    ...
    <script src="{{URL::to('bower_components/datatables-buttons/js/buttons.colVis.js')}}"></script>
    <script src="{{URL::to('bower_components/datatables-buttons/js/buttons.html5.js')}}"></script>
    <script src="{{URL::to('bower_components/datatables-buttons/js/buttons.print.js')}}"></script>
    
    <!-- datatables custom integration -->
    <script src="{{URL::to('assets/js/custom/datatables/datatables.uikit.min.js')}}"></script>

    <!--  datatables functions -->
    <script src="{{URL::to('assets/js/pages/plugins_datatables.min.js')}}"></script>
    ...
    <!-- page specific plugins -->
        ...
        <!-- maplace (google maps) -->
        <script src="{{URL::to('http://maps.google.com/maps/api/js')}}"></script>
        <script src="{{URL::to('bower_components/maplace-js/dist/maplace.min.js')}}"></script>
        <!-- peity (small charts) -->
        ...
        <!-- countUp -->
        <script src="{{URL::to('bower_components/countUp.js/dist/countUp.min.js')}}"></script>
        <!-- handlebars.js -->
        <script src="{{URL::to('bower_components/handlebars/handlebars.min.js')}}"></script>
        <script src="{{URL::to('assets/js/custom/handlebars_helpers.min.js')}}"></script>
        <!-- CLNDR -->
        <script src="{{URL::to('bower_components/clndr/clndr.min.js')}}"></script>
    ...
    <!-- delete job appliction---->
    <script type="text/javascript">
        $(function(){
            $(".del_applyer").click(function(e){
                e.preventDefault();
                var jobp_id = $(this).attr("href");
                var dataString = 
                'jobp_id='+jobp_id;
                alertify.confirm('Warning ', 'Are You Sure, You Want To Delete This Applyer?', function(){
                    $.ajax({
                        type:'post',
                        url:'post_url/del_applyer.php',
                        data:dataString,
                        success:function(res){
                            if(res == "1"){
                                alertify.success('Successfully deleted this Applyer');
                                function explode(){
                                    location.href = 'manage_job_appliction.php';
                                };
                                setTimeout(explode,3000);
                            }else{
                                alertify.success('Undone! Not deleted');
                            }
                        }
                    })
                },function(){ 
                alertify.error('Welcome back to adminpanel');
                });             
            });
        })
    </script>
