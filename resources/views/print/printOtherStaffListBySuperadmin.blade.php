...
<body style="font-family:arial;">
      ...
      <br>
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">STAFFS LIST</span></h4></center>      
      <div class="row">
        <table>
          <tr>
            <td>Printed on</td>
