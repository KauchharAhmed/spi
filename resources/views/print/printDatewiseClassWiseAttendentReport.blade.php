...
<body style="font-family:arial;">
      ...
      <br>
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">PERIODIC STUDENT'S CLASS WISE ATTENDENT REPORTS</span></h4></center>      
      <div class="row">
        <table>
          <tr>
            <td>Year</td>
          ...
          <tr>
            ...
            <td>:</td>
            <td><b>
              <?php echo date ("d M Y", strtotime($from)).' To '.date("d M Y", strtotime($to));?>
            </b></td>
          </tr>
           <tr>
   ...
   <table width="100%" class="nila" style="font-size:14px;">
                  <thead>
                    ...
                    <td class="nila"><strong>TOTAL SUBJECT CLASS</strong></td>
