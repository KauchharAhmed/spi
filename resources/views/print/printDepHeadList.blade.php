...
<body style="font-family:arial;">
      ...
      <br>
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">DEPARTMENT HEAD LIST</span></h4></center>      
      <div class="row">
        <table>
          <tr>
            <td>Printed on</td>
   ...
   <table width="100%" class="nila" style="font-size:14px;">
                  <thead>
                    ...
                    <td class="nila"><strong>DEP NAME</strong></td>
                    <td class="nila"><strong>NAME</strong></td>
                    <td class="nila"><strong>TITLE</strong></td>
                    <td class="nila"><strong>MOBILE</strong></td>
                    <td class="nila"><strong>IMAGE  </strong></td>
                    <td class="nila"><strong>SIGNATURE</strong></td>
            </tr>
            </thead>
