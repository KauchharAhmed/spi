...
<body style="font-family:arial;">
      <div class="compnayInfo" style="margin-bottom: 20px;">
        ...
        <div class="address">
          ...
          <p><?php echo $setting->mobile.$percentage_class_number;?></p>
        </div>
        <div class="bd_logo">
      ...
      <br>
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">PERIODIC CLASS WISE PERCENTAGE ABSENT LIST</span></h4></center>      
      <div class="row">
        <table>
          <tr>
            <td>Year</td>
