...
<body style="font-family:arial;">
      ...
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">TEACHER TODAY CLASS ATTENDENT REPORT</span></h4></center>      
      <div class="row">
        ...
        <table>
          ...
          <tr>
            <td>Day</td>
            <td>:</td>
            <td><b><?php echo $day_no  = date("l"); ?></b></td>
          </tr>
          <tr>
            <td>Printed on</td>
            <td>:</td>
