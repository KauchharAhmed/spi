...
<body style="font-family:arial;">
      ...
      <center><h4 style="margin-top: 89px;"><span style="font-family:arial;border:1px solid #000;padding-top:4px;padding-bottom:4px;padding-left:27px;padding-right:27px;">MONTHLY TEACHER CLASS ATTENDENT REPORT</span></h4></center>      
      <div class="row">
        <table>
          <tr>
            <td>YEAR</td>
          ...
          <tr>
            ...
            <td><b><?php 
                    ...
                    <tr>
            <td>MONTH TOTAL DAYS</td>
            <td>:</td>
            <td><b><?php echo $month_total_day.' Days' ;?></b></td>
          </tr>
          <tr>
            <td>HOLIDAYS</td>
            <td>:</td>
            <td><b><?php echo $count_holiday.' Days' ; ?></b></td>
          </tr>
          <tr>
            <td>Printed on</td>
            <td>:</td>
   ...
   <table width="100%" class="nila" style="font-size:14px;">
                  <thead>
                    ...
                    <td class="nila"><strong>TOTAL CLSS (DAYS)<sub>without leave & trainig</strong></td>
